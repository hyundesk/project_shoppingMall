...
CREATE TABLE `shopbanner` (
  ...
  `bannerurl` varchar(4500) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `shopbanner` VALUES (1,'http://localhost:8000/banner1.png'),(2,'http://localhost:8000/banner2.png'),(3,'http://localhost:8000/banner3.png'),(4,'http://localhost:8000/banner4.png'),(5,'http://localhost:8000/banner5.png'),(6,'http://localhost:8000/banner6.png');
